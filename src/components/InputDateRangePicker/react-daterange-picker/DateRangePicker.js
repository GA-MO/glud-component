...
var DateRangePicker = (0, _createReactClass2.default)({
  ...
  componentWillReceiveProps: function componentWillReceiveProps(nextProps) {
    ...
    var updatedState = {
      ...
      hideSelection: false,
      dateStates:
        this.state.dateStates && _immutable2.default.is(this.state.dateStates, nextDateStates)
          ? this.state.dateStates
          : nextDateStates,
      enabledRange:
        this.state.enabledRange && this.state.enabledRange.isSame(nextEnabledRange)
  ...
  getInitialState: function getInitialState() {
    ...
    if (
      initialFromValue &&
      (_momentRange2.default.isMoment(value) || (0, _isMomentRange2.default)(value))
    ) {
  ...
  getEnabledRange: function getEnabledRange(props) {
    var min = props.minimumDate
      ? (0, _momentRange2.default)(props.minimumDate).startOf('day')
      : absoluteMinimum
    var max = props.maximumDate
      ? (0, _momentRange2.default)(props.maximumDate).startOf('day')
      : absoluteMaximum
  ...
  isStartOrEndVisible: function isStartOrEndVisible(props) {
    ...
    var isVisible = function isVisible(date) {
      ...
      var isMonthVisible =
        yearMonth.month === _this.state.month ||
  ...
  changeYear: function changeYear(year) {
    ...
    if (
      (0, _momentRange2.default)({ years: year, months: month, date: 1 }).unix() <
    ...
    if (
      (0, _momentRange2.default)({ years: year, months: month + 1, date: 1 }).unix() >
  ...
  renderCalendar: function renderCalendar(index) {
    ...
    if (
      !(0, _isMomentRange2.default)(highlightedRange) ||
