...
var CalendarMonth = (0, _createReactClass2.default)({
  ...
  setLocale: function setLocale (locale) {
    ...
    this.WEEKDAYS = _immutable2.default
      .List(_momentRange2.default.weekdays())
      .zip(_immutable2.default.List(_momentRange2.default.weekdaysShort()))
  ...
  renderDay: function renderDay (date, i) {
    ...
    if (
      !hideSelection &&
      value &&
      _momentRange2.default.isMoment(value) &&
      value.isSame(d, 'day')
    ) {
      isSelectedDate = true
    } else if (
      !hideSelection &&
      value &&
      (0, _isMomentRange2.default)(value) &&
      value.contains(d)
    ) {
  ...
  renderDayHeaders: function renderDayHeaders () {
    ...
    var indices = _immutable2.default
      .Range(firstOfWeek, 7)
      .concat(_immutable2.default.Range(0, firstOfWeek))

    var headers = indices.map(
      function (index) {
        var weekday = this.WEEKDAYS.get(index)
        return _react2.default.createElement(
          'th',
          { className: this.cx({ element: 'WeekdayHeading' }), key: weekday, scope: 'col' },
          _react2.default.createElement('abbr', { title: weekday[0] }, weekday[1])
        )
      }.bind(this)
    )
  ...
  renderYearChoice: function renderYearChoice (year) {
    ...
    return _react2.default.createElement(
      'option',
      { key: year, value: year },
      (0, _momentRange2.default)(year, 'YYYY')
  ...
  renderHeaderYear: function renderHeaderYear () {
    ...
    var years = _immutable2.default.Range(y - 90, y).concat(_immutable2.default.Range(y, y + 30))
  ...
  renderMonthChoice: function renderMonthChoice (month, i) {
    ...
    if (
      (0, _momentRange2.default)({ years: year, months: i + 1, date: 1 }).unix() <
    ...
    if (
      (0, _momentRange2.default)({ years: year, months: i, date: 1 }).unix() >
  ...
  render: function render () {
    ...
    var monthDates = _immutable2.default.fromJS(
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement('thead', null, this.renderDayHeaders()),
        _react2.default.createElement('tbody', null, weeks.toJS())
      )
    )
  }
})
